...
public class LoginView {
    ...
    private MenuView personView = new MenuView();
    int choice;
...
//        ExceptionHandler.checkPassWord(passWord);
        if (!ExceptionLogin.readFromFile(userName , passWord)){
    ...
    private void showAllSignUp() {
        ...
        System.out.println("Nhập mật khẩu :");
        String passWord = sc.nextLine();
        ExceptionLogin.checkPassWord(passWord);
        ...
        ExceptionLogin.writeToFile(userName,passWord,phone,address,email,name,age);
    }
