...
public class PersonView {
    ...
    private void showAllCurrent() {
        ExceptionHandler.showAllAccount();
    }
...
//        this.billController.revenueByMonth(month,year);
    ...
    private void showEditBills() {
        ...
        ExceptionHandler.editBillInFile(idIndex,bills);
    ...
    private void showAddBills() {
        ...
        ExceptionHandler.wriyetoFileBill(id,nameRoom,tenantName,employeeName,startDate,endDate,totalPrice);
    }
    ...
    private void showCheckRoom() {
        ...
        LocalDate endDate = ExceptionHandler.checkParseLocaDate();
        this.roomController.checkRooms(nameRoom);
    }
    ...
    private void showEditRoom() {
        ...
        ExceptionHandler.editRoomInFile(idIndex,room);
        System.out.println("ĐÃ SỬA THÀNH CÔNG");
    }

    private void showAllRooms() {
        List<Room> roomList = ExceptionHandler.readRoomsFromFile();
        if (roomList.isEmpty()) {
    ...
    private void showAddRoom() {
        ...
        ExceptionHandler.writetoFileRoom(idRoom,nameRoom, numberToilet, numberBedRoom, price, status,startDate,endDate);
